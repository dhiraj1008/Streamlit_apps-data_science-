...
st.markdown("""
This app performs simple webscraping of NPL Football player stats data(focusing on Rushing)
* **Python libraries:** base64,pandas,streamlit,matplotlib,seaborn,numpy
* **Data source:** [pro-football-reference.com](https://www.pro-football-reference.com/years/)
""")
